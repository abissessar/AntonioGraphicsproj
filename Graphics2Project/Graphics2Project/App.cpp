...
void App::SetWindow(CoreWindow^ window)
{
	...
	window->PointerExited +=
		ref new Windows::Foundation::TypedEventHandler<Windows::UI::Core::CoreWindow ^, Windows::UI::Core::PointerEventArgs ^>(this, &Graphics2Project::App::OnPointerExited);
...
void App::Load(Platform::String^ entryPoint)
{
	if (m_main == nullptr)
	{
		m_main = std::unique_ptr<Graphics2ProjectMain>(new Graphics2ProjectMain(m_deviceResources));
	}
}
...
void Graphics2Project::App::OnKeyDown(Windows::UI::Core::CoreWindow ^ sender, Windows::UI::Core::KeyEventArgs ^ args)
{
...
void Graphics2Project::App::OnKeyUp(Windows::UI::Core::CoreWindow ^ sender, Windows::UI::Core::KeyEventArgs ^ args)
{
